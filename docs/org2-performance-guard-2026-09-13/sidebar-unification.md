...
Shared row primitives are stateless; the section action portal is scoped to its mounted provider. Virtual row pitch includes the 1px gap. Timeline data hooks keep their existing ownership; refresh actions move to the section header.
