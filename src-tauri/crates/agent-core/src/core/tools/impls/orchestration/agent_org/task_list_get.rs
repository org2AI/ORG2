...
impl Tool for TaskListTool {
    ...
    fn description(&self) -> &str {
        concat!(
            ...
            "certificate or proof of delivery. completion_candidate.state=ready proves ",
            "record closure, not acceptance of the user's requested deliverables. Compare ",
            "the actual TaskOutput evidence with the acceptance criteria; create missing ",
            "work or dependent repair/verification when required. Once the evidence meets ",
            "the request, call org_run_complete; do not refresh task_list just to reconfirm closure. ",
