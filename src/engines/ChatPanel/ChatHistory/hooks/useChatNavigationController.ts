...
export { isAgentOrgOverviewInteractionTarget } from "./useAgentOrgOverviewDisclosure";
...
export function useChatNavigationController({
  ...
  const { open: agentOrgOverviewOpen, setOpen: setAgentOrgOverviewOpen } =
    useAgentOrgOverviewDisclosure({
      available: agentOrgOverviewAvailable,
      scopeKey: activeId,
    });
